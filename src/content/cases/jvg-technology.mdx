...
description: 'At J. v. G. technology GmbH, we revamped their email funnel to skyrocket engagement, achieving up to a 255% increase in open rates and a 940% boost in click rates, and developed a comprehensive conversion tracking and attribution platform.'
summary:
  - 'At J. v. G. technology GmbH, we overhauled their email strategy, leading to a 255% increase in open rates and a 940% rise in click rates, crucial for their complex sales cycle.'
  - 'We also created a detailed conversion tracking and marketing attribution platform, improving data-driven decision-making. '
...
<TagList>
  ...
  <TagListItem>Thrive Leads</TagListItem>
...
<StatList className='my-32 !max-w-none' client:load>
  ...
  <StatListItem client:load value="4.6" label="Trustpilot Rating In Highly-Competitive Environment" />
</StatList>
